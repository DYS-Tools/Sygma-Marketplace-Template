...
class MakeJsonFormat
{
    ...
    /* Return Json for statistic author Graph */
    public function get30LastDaysCashflow($user) 
    {
        $BeforeDay1 = 1;
        //dump(count($this->orderRepo->getByDateByAuthor(new DateTime('-0days'), $user, 0)));
        $Array30LastCashflow = [
            'j-0' => $this->orderRepo->getCashFlowWithDate(new DateTime('-0days'), $user),
            'j-1' => $this->orderRepo->getCashFlowWithDate(new DateTime('-1days'), $user),
            'j-2' => $this->orderRepo->getCashFlowWithDate(new DateTime('-2days'), $user),
            'j-3' => $this->orderRepo->getCashFlowWithDate(new DateTime('-3days'), $user),
            'j-4' => $this->orderRepo->getCashFlowWithDate(new DateTime('-4days'), $user),
            'j-5' => $this->orderRepo->getCashFlowWithDate(new DateTime('-5days'), $user),
            'j-6' => $this->orderRepo->getCashFlowWithDate(new DateTime('-6days'), $user),
            'j-7' => $this->orderRepo->getCashFlowWithDate(new DateTime('-7days'), $user),
            'j-8' => $this->orderRepo->getCashFlowWithDate(new DateTime('-8days'), $user),
            'j-9' => $this->orderRepo->getCashFlowWithDate(new DateTime('-9days'), $user),
            'j-10' => $this->orderRepo->getCashFlowWithDate(new DateTime('-10days'), $user),
            'j-11' => $this->orderRepo->getCashFlowWithDate(new DateTime('-11days'), $user),
            'j-12' => $this->orderRepo->getCashFlowWithDate(new DateTime('-12days'), $user),
            'j-13' => $this->orderRepo->getCashFlowWithDate(new DateTime('-13days'), $user),
            'j-14' => $this->orderRepo->getCashFlowWithDate(new DateTime('-14days'), $user),
            'j-15' => $this->orderRepo->getCashFlowWithDate(new DateTime('-15days'), $user),
            'j-16' => $this->orderRepo->getCashFlowWithDate(new DateTime('-16days'), $user),
            'j-17' => $this->orderRepo->getCashFlowWithDate(new DateTime('-17days'), $user),
            'j-18' => $this->orderRepo->getCashFlowWithDate(new DateTime('-18days'), $user),
            'j-19' => $this->orderRepo->getCashFlowWithDate(new DateTime('-19days'), $user),
            'j-20' => $this->orderRepo->getCashFlowWithDate(new DateTime('-20days'), $user),
            'j-21' => $this->orderRepo->getCashFlowWithDate(new DateTime('-21days'), $user),
            'j-22' => $this->orderRepo->getCashFlowWithDate(new DateTime('-22days'), $user),
            'j-23' => $this->orderRepo->getCashFlowWithDate(new DateTime('-23days'), $user),
            'j-24' => $this->orderRepo->getCashFlowWithDate(new DateTime('-24days'), $user),
            'j-25' => $this->orderRepo->getCashFlowWithDate(new DateTime('-25days'), $user),
            'j-26' => $this->orderRepo->getCashFlowWithDate(new DateTime('-26days'), $user),
            'j-27' => $this->orderRepo->getCashFlowWithDate(new DateTime('-27days'), $user),
            'j-28' => $this->orderRepo->getCashFlowWithDate(new DateTime('-28days'), $user),
            'j-29' => $this->orderRepo->getCashFlowWithDate(new DateTime('-29days'), $user),
            'j-30' => $this->orderRepo->getCashFlowWithDate(new DateTime('-30days'), $user),
        ];
        
        return $Array30LastCashflow;
    }
